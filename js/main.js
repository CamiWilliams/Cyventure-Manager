var myDataRef;
var path="https://cyventure-manager.firebaseio.com/messages";
...
$("#home").click(function() {
    if(mainNode.parent()!=undefined)
    {
        ...
        mainNode.off('child_added');
        $("#myTable").empty();
        $('#myTable').append('<tr><td>Username</td><td>Message</td><td>Comments</td></tr>');

        path="https://cyventure-manager.firebaseio.com/messages";
        mainNode=new Firebase(path);
        mainNode.on('child_added', addChild);
